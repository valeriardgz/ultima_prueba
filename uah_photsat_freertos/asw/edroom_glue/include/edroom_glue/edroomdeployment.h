...
//Signal Conversion
	...
	static TEDROOMSignal C4TCManager_PO_Mng_Ctrl__C5ObsMng_PO_Mng_Ctrl(TEDROOMSignal signal);
	static TEDROOMSignal C5ObsMng_PO_Mng_Ctrl__C4TCManager_PO_Mng_Ctrl(TEDROOMSignal signal);
