...
TEDROOMSignal CEDROOMSystemCommSAP::C4TCManager_PO_Mng_Ctrl__C5ObsMng_PO_Mng_Ctrl(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C5ObsMng_PO_Mng_Ctrl__C4TCManager_PO_Mng_Ctrl(TEDROOMSignal signalOut){
...
void CEDROOMSystemCommSAP::RegisterInterfaces(){
	...
	m_localCommSAP.RegisterInterface(1, mp_comp4->O_Mng_Ctrl, mp_comp4);
	...
	m_localCommSAP.RegisterInterface(3, mp_comp5->O_Mng_Ctrl, mp_comp5);
...
void CEDROOMSystemCommSAP::SetLocalConnections(){
	...
	m_localCommSAP.Connect(mp_comp4->O_Mng_Ctrl, mp_comp5->O_Mng_Ctrl, connections[0], 
					C4TCManager_PO_Mng_Ctrl__C5ObsMng_PO_Mng_Ctrl, 
					C5ObsMng_PO_Mng_Ctrl__C4TCManager_PO_Mng_Ctrl);
